				...
				<div class="card shadow-lg wow bounceIn" data-wow-delay="0.4s" style="width: 18rem;">
				    <img class="card-img-top" src="images/books.jpg" alt="Card image cap">
				  		<div class="card-body">
						    ...
						    <a href="prof-view-books.php" class="btn btn-primary">Let's go</a>
				  		</div>
				</div>
			</div>
			<div class="col-md-4">
...
<br><br>
			...
			<div class="col-md-4">
				<div class="card shadow-lg wow bounceIn" data-wow-delay="1.0s" style="width: 18rem;" >
			...
			<div class="col-md-4">
				<div class="card shadow-lg wow bounceIn" data-wow-delay="1.2s" style="width: 18rem;" >
...
<br><br>
			...
			<div class="col-md-4">
				<div class="card shadow-lg wow bounceIn" data-wow-delay="0.4s" style="width: 18rem;" >
				    <img class="card-img-top" src="images/departments.jpg"  alt="Card image cap" style="height: 200px;">
				  		<div class="card-body">
						    <h5 class="card-title">Departments</h5>
						    <p class="card-text">Click here to view Departments </p>
						    <a href="student-view-lab.php" class="btn btn-primary">Let's go</a>
				  		</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card shadow-lg wow bounceIn" data-wow-delay="0.6s" style="width: 18rem;" >
				    <img class="card-img-top" src="images/b-borrow.jpg"  alt="Card image cap" style="height: 200px;">
				  		<div class="card-body">
						    <h5 class="card-title">Borrowings</h5>
						    <p class="card-text">Click here to view borrowed books </p>
						    <a href="student-view-lab.php" class="btn btn-primary">Let's go</a>
				  		</div>
				</div>
			</div>
